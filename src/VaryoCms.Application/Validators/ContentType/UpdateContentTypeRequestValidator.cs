...
public class UpdateContentTypeRequestValidator : AbstractValidator<UpdateContentTypeRequest>
{
    private readonly IStringLocalizer<SharedResource> _localizer;

    public UpdateContentTypeRequestValidator(IStringLocalizer<SharedResource> localizer)
    {
